...
public class AlarmListViewActivity extends Activity {
	...
	private AlarmModule am = new AlarmModule();
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		list.setOnDataSelectionListener(new OnDataSelectionListener() {
			public void onDataSelected(AdapterView parent, View v, int position, long id) {
				...
				AlertDialog dialog = new AlertDialog.Builder(AlarmListViewActivity.this).create();
				dialog.setTitle("Are you sure??");
				dialog.setButton("Delete", new Dialog.OnClickListener() {
    ...
    public Dialog getRepeatingDaysDialog()
    {
    	...
    	builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				am.setTimerWithTask(getApplicationContext(), AlarmTask.class, 20);		// set the Alarm
