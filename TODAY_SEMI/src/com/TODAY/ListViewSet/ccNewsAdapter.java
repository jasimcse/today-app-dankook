...
public class ccNewsAdapter extends BaseAdapter implements RemoveInterface
{
	// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

	Context context ;	
	int layoutRes ;					//	Custom Cell View
	ArrayList<News_Info> list ;		//	Custom Cell Contents
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		desc.setText(list.get(INDEX).getDescription()) ;
	...
	public ccNewsAdapter(Context context, int layoutRes, ArrayList<News_Info> list)
	{
